...
namespace DepotDownloader
{
    ...
    public class Steam3Session
    {
        ...
        public IDictionary<uint, byte[]> AppTickets { get; }

        public IDictionary<uint, ulong> AppTokens { get; }

        public IDictionary<uint, byte[]> DepotKeys { get; }

        public IDictionary<string, TaskCompletionSource<SteamApps.CDNAuthTokenCallback>> CDNAuthTokens { get; }

        public IDictionary<uint, SteamApps.PICSProductInfoCallback.PICSProductInfo> AppInfo { get; }

        public IDictionary<uint, SteamApps.PICSProductInfoCallback.PICSProductInfo> PackageInfo { get; }

        public IDictionary<string, byte[]> AppBetaPasswords { get; }
        ...
        public Steam3Session(SteamUser.LogOnDetails details)
        {
            ...
            this.AppTickets = new ConcurrentDictionary<uint, byte[]>();
            this.AppTokens = new ConcurrentDictionary<uint, ulong>();
            ...
            this.AppInfo = new ConcurrentDictionary<uint, SteamApps.PICSProductInfoCallback.PICSProductInfo>();
            this.PackageInfo = new ConcurrentDictionary<uint, SteamApps.PICSProductInfoCallback.PICSProductInfo>();
            this.AppBetaPasswords = new ConcurrentDictionary<string, byte[]>();
        ...
        [MethodImpl(MethodImplOptions.Synchronized)]
        public void TryWaitForLoginKey(ContentDownloader context)
        {
            if (logonDetails.Username == null || !(context?.Config.RememberPassword ?? false)) return;
