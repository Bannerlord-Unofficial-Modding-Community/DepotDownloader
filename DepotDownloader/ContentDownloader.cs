...
namespace DepotDownloader
{
    ...
    public class ContentDownloader
    {
        ...
        private bool ownsSteam3;

        private bool ownsCdnPool;
        ...
        public ContentDownloader(string username, string password) : this()
        {
            ...
            {
                throw new ContentDownloaderException("Unable to get steam3 credentials.");
            }
        ...
        public void ShutdownSteam3()
        {
            ...
            if (ownsSteam3)
            {
                steam3.TryWaitForLoginKey(this);
                steam3.Disconnect();
            }
        ...
        public async Task DownloadPubfileAsync(uint appId, ulong publishedFileId, CancellationToken ct)
        {
        ...
        {
            if (steam3 == null)
                throw new InvalidOperationException("A Steam session must be associated with the ContentDownloader instance.");
        ...
        private async Task DownloadSteam3Async(uint appId, List<DepotDownloadInfo> depots, CancellationToken ct)
        {
            if (CdnPool == null)
